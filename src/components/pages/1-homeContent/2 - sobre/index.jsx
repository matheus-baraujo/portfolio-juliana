  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.subtitleMobile}>
        ...
        <h2>Sou mente engenheira e alma comunicadora.</h2>
      </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.col+' '+styles.col2}>
          ...
          <p>Planejo e produzo vídeos que revelam a autenticidade das marcas e traduzem sua missão de forma envolvente, real e funcional.</p>
